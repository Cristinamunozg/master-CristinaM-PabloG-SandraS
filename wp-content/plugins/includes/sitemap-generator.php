...
echo '<a class="exitbutton" href="' . $rutita . '/pablomap.xml" target="_blank">Comprobar Sitemap</a>';
...
$rootnoticia->setAttribute('xmlns:news', 'http://www.sitemaps.org/schemas/sitemap-news/0.9');
...
echo '<a class="exitbutton" href="' . $rutita . '/news.xml" target="_blank">Comprobar Sitemap</a>';
$domnoticia->save('news.xml') or die('XML Create Error');
?>
</section>


<style>
.site-footer{display:none}.codigo-post{background:var(--light-grey);padding:40px 16px 16px;
cursor:text;font-size:16px;overflow-x:scroll;display:block;max-width:100%;min-width:100px;
background-color:#0c1021;color:#fff;
